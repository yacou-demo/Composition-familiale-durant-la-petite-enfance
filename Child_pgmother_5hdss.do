...
drop if pgmotherId=="---------"
duplicates drop hdss IndividualId  pgmotherId,force
...
keep IndividualId pgmotherid DoBPGM hdss
...
merge m:1 hdss IndividualId  using pgmother_childID_sahel.dta
keep if _merge==3
drop _merge
sort hdss IndividualId EventDate EventCode
...
keep IndividualId pgMotherId DoB hdss
duplicates drop
rename IndividualId ChildId
...
use residency_sahel, clear
merge m:1 hdss IndividualId using pgmother_children_sahel.dta
*drop DoB*
