...
duplicates drop IndividualId PuncleId`i' DoB hdss socialgpId,force
rename IndividualId ChildId
...
sort hdss IndividualId EventDate 
bys hdss  IndividualId : replace sgp_puncle`i'=sgp_puncle`i'[_N] if EventCodepuncle`i'==9 & EventCodepuncle`i'[_N]==9 & _n==_N-1
sort hdss IndividualId EventDate EventCode

sort hdss IndividualId EventDate 
capture drop dup_e
sort hdss IndividualId EventDate EventCode
 bys hdss IndividualId EventDate EventCode EventCodepuncle`i' sgp_puncle`i': gen dup_e= cond(_N==1,0,_n)
