use   MacroIndividualR10.dta,clear

foreach var of varlist  birth_date {
gen `var'_1=date(`var',"DMY")
format %td `var'_1
drop `var' 
rename `var'_1 `var'
}
...
save family_Ouaga_all_var,replace

keep IndividualId DoB Sex  fatherId DoBFA motherId DoBMO mgmotherId DoBMGM SexMGM mgfatherId DoBMGF SexMGF pgfatherId DoBPGF SexPGF pgmotherId DoBPGM SexPGM socialgpid_*

save family_Ouaga, replace
...
drop socialgpid_*
sort IndividualId 
merge 1:m IndividualId using residency_Ouaga_final ,keepus(socialgpid)gen(merge_sgp)
sort IndividualId 
rename socialgpid socialgpId
drop if fatherId=="" & motherId==""& pgfatherId=="" & pgmotherId=="" & mgfatherId =="" & mgmotherId==""
save familly_Ouaga_final, replace


**Oncles, cousins et tantes


use familly_Ouaga_final,clear
...
save family_Ouaga_puncle,replace
...
keep IndividualId DoB Sex paunt_ego DoB_paunt socialgpId
...
format DoB_paunt* %td
save family_Ouaga_paunt,replace
...
save family_Ouaga_muncle,replace
...
format DoB_maunt* %td
save family_Ouaga_maunt,replace
...
duplicates drop    IndividualId,force
sort   IndividualId 
merge 1:1  IndividualId using family_Ouaga_puncle,gen(mergep)
sort  IndividualId
merge 1:1  IndividualId using family_Ouaga_paunt,gen(mergea)
sort  IndividualId
merge 1:1  IndividualId using family_Ouaga_muncle,gen(mergem)
sort  IndividualId
merge 1:1  IndividualId using family_Ouaga_maunt,gen(mergema)
drop merge*
drop if motherId=="" & fatherId==""
save familly_Ouaga_fnetwork, replace
