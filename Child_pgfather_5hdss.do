...
drop if pgfatherId=="---------"
duplicates drop hdss IndividualId  pgfatherId,force
...
keep IndividualId pgfatherid DoBPGF hdss
...
merge m:1 hdss IndividualId  using pgfather_childID_sahel.dta
keep if _merge==3
drop _merge
sort hdss IndividualId EventDate EventCode
...
keep IndividualId pgFatherId DoB hdss
duplicates drop
rename IndividualId ChildId
...
use residency_sahel, clear
merge m:1 hdss IndividualId using pgfather_children_sahel.dta
*drop DoB*
