...
duplicates drop hdss socialgpId IndividualId  muncleid_ego`i',force
...
sort hdss IndividualId EventDate 
bys hdss  IndividualId : replace sgp_muncle`i'=sgp_muncle`i'[_N] if EventCodemuncle`i'==9 & EventCodemuncle`i'[_N]==9 & _n==_N-1
sort hdss IndividualId EventDate EventCode

sort hdss IndividualId EventDate 
capture drop dup_e
sort hdss IndividualId EventDate EventCode
 bys hdss IndividualId EventDate EventCode EventCodemuncle`i' sgp_muncle`i': gen dup_e= cond(_N==1,0,_n)
