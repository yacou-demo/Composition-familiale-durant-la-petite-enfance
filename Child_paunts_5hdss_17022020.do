...
merge m:1 hdss  socialgpId  IndividualId   using paunt`i'_childID_sahel.dta
keep if _merge==3
drop _merge
sort hdss IndividualId EventDate EventCode
...
duplicates drop IndividualId PauntId`i' DoB hdss socialgpId,force
rename IndividualId ChildId
...
bys IndividualId : replace last_record_date=21658  if   hdss==1
bys IndividualId : replace last_record_date=21185  if   hdss==2
bys IndividualId : replace last_record_date=21425  if   hdss==3
bys IndividualId : replace last_record_date=20454  if   hdss==4
bys IndividualId : replace last_record_date=21185  if   hdss==5
...
sort hdss IndividualId EventDate 
bys hdss  IndividualId : replace sgp_paunt`i'=sgp_paunt`i'[_N] if EventCodepaunt`i'==9 & EventCodepaunt`i'[_N]==9 & _n==_N-1
sort hdss IndividualId EventDate EventCode

sort hdss IndividualId EventDate 
capture drop dup_e
sort hdss IndividualId EventDate EventCode
 bys hdss IndividualId EventDate EventCode EventCodepaunt`i' sgp_paunt`i': gen dup_e= cond(_N==1,0,_n)
