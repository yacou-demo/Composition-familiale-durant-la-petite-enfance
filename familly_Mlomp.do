use  Individual_2.dta,clear

tostring pere,replace
tostring mere,replace

replace pere="" if pere=="0"
replace mere="" if mere=="0"


count if pere==""
count if mere==""

rename pere fatherId
rename mere motherId
rename sexe Sex
rename birth_date_1 DoB
...
save family_Mlomp_all_var,replace
...
sort IndividualId 
merge 1:m IndividualId using residency_Mlomp_final ,keepus(socialgpid)gen(merge_sgp)
sort IndividualId 
rename socialgpid socialgpId
drop if fatherId=="" & motherId==""& pgfatherId=="" & pgmotherId=="" & mgfatherId =="" & mgmotherId==""

save familly_Mlomp_final, replace


**Oncles, cousins et tantes
use familly_Mlomp_final,clear
sort IndividualId 
...
save family_Mlomp_puncle,replace
...
format DoB_paunt* %td
save family_Mlomp_paunt,replace
...
save family_Mlomp_muncle,replace
...
format DoB_maunt* %td
save family_Mlomp_maunt,replace

****Mlomp Familly

use familly_Mlomp_final,clear
duplicates drop   IndividualId,force
merge 1:1  IndividualId using family_Mlomp_puncle,gen(mergep)
sort  IndividualId
merge 1:1  IndividualId using family_Mlomp_paunt,gen(mergea)
sort  IndividualId
merge 1:1  IndividualId using family_Mlomp_muncle,gen(mergem)
sort socialgpId IndividualId
merge 1:1  IndividualId using family_Mlomp_maunt,gen(mergema)
drop merge*
...
save familly_Mlomp_fnetwork, replace
